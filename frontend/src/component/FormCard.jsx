    ...
    <div className="form_Card">
      <div className="form_card_1">
        ...
        >
          ...
          <span> <Link to={`/table/${form.id}`}>{form.total} submissions.</Link> {form.updatedAt && `Updated on ${new Date(form.updatedAt).toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' })}`}</span>
        </div>
      </div>
